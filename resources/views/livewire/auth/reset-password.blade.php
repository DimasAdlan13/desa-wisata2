<div>
    <div class="space-y-6">
        <div>
            ...
            <p class="text-gray-500 text-sm mt-1">Masukkan password baru untuk akun kamu.</p>
        </div>
        ...
        <form wire:submit.prevent="resetPassword" class="space-y-4">
            <div>
                ...
                <input wire:model="email" type="email" placeholder="email@kamu.com"
                       class="w-full border border-gray-200 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-teal-400 bg-gray-50 @error('email') border-red-300 @enderror">
            ...
            <div>
                ...
                <input wire:model="password_confirmation" type="password" placeholder="Ulangi password baru"
                       class="w-full border border-gray-200 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-teal-400 @error('password_confirmation') border-red-300 @enderror">
        ...
        <p class="text-center text-sm text-gray-500">
            <a href="{{ route('login') }}" wire:navigate class="text-teal-600 hover:underline font-medium">Kembali ke halaman masuk</a>
        </p>
    </div>
</div>
