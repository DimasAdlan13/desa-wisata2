    ...
    <div class="space-y-4">
        ...
        <form wire:submit.prevent="register" class="space-y-4">
            ...
            @if($step === 1)
                <div class="mb-4">
                    <div class="flex justify-between items-center mb-2">
                        <span class="text-xs font-bold text-teal-600 bg-teal-50 px-2 py-1 rounded-md">Langkah 1 dari
                            2</span>
            ...
            @if($step === 2)
                <div class="mb-4">
                    <div class="flex justify-between items-center mb-2">
                        <span class="text-xs font-bold text-teal-600 bg-teal-50 px-2 py-1 rounded-md">Langkah 2 dari
                            2</span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div x-data="{ show: false }">
                        ...
                        <div class="relative">
                            <input wire:model="password" :type="show ? 'text' : 'password'" placeholder="Min. 8 karakter"
                    ...
                    <div x-data="{ show: false }">
                        <label class="block text-sm font-medium text-gray-700 mb-1 truncate"
                            title="Konfirmasi Password">Konfirmasi Password</label>
                        <div class="relative">
                            <input wire:model="passwordConfirm" :type="show ? 'text' : 'password'"
                ...
                <div class="flex gap-3 mt-6">
                    ...
                    <button type="submit"
                        ...
                        <span wire:loading.remove
                            wire:target="register">{{ $role === 'admin_layanan' ? ' Ajukan Pendaftaran Mitra' : 'Daftar Sekarang' }}</span>
